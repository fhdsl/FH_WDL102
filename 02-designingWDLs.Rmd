...
## Workflow Structure
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/workflow.md", branch = "1.0")
```

### Inputs
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/specify_inputs.md", branch = "1.0")
```

### Calls
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/call.md", branch = "1.0")
```
...
### Tasks
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/task.md", branch = "1.0")
```

Task aliasing.
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/task_aliasing.md", branch = "1.0")
```
...
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/add_variables.md", branch = "1.0")
```


```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/add_plumbing.md", branch = "1.0")
```

```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/Linear_chaining.md", branch = "1.0")
```


```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/ScatterGather_parallelism.md", branch = "1.0")
```
