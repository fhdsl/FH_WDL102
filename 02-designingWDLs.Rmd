...
There is a tool that is installed along with Cromwell called "womtool".  This tool is what does workflow valdiation through the Shiny app and fh.wdlR package.  However, it has additional features that are not available unless you run it directly.    
