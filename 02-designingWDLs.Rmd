...
### Inputs
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/specify-inputs.md", branch = "1.0")
```
...
Task aliasing.
```{r, echo = FALSE, results = "asis"}
cow::borrow_chapter(repo_name = "openwdl/wdl-docs", "Docs/task-aliasing.md", branch = "1.0")
```
